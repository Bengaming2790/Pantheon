...
public class ModAltarBlocks {
    ...
    public static void register() {
        ...
        FIRE_ALTAR = registerAltar("fire_altar", new AltarRecipe(
                Map.of(Items.BLAZE_POWDER, 4, Items.MAGMA_CREAM, 2),
                10,
        ...
        KHALKEUS_ALTAR = registerAltar("khalkeus_altar", new AltarRecipe(
                Map.of(ModItems.DRACHMA, 75, Items.NETHERITE_INGOT, 3,
                        Items.BLAZE_ROD, 32, Items.HEAVY_CORE, 1, Items.ANVIL, 16),
                10,
        ...
        AEGIS_ALTAR = registerAltar("aegis_altar", new AltarRecipe(
                Map.of(ModItems.DRACHMA, 75, Items.GOLD_BLOCK, 32,
                        Items.IRON_BLOCK, 64, Items.FERMENTED_SPIDER_EYE, 16,
